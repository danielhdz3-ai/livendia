...
const city = getVenderPisoSinAgenciaCity("valencia")!;
const canonical = `${getSiteUrl()}${localVenderPisoSinAgenciaHref("valencia")}`;
    ...
    images: [
      {
        ...
        alt: "Vender piso sin agencia en Valencia con Livendia",
      },
    ],
  },
};

export default function VenderPisoSinAgenciaValenciaPage() {
