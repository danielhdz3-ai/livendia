...
const city = getVenderPisoSinAgenciaCity("madrid")!;
const canonical = `${getSiteUrl()}${localVenderPisoSinAgenciaHref("madrid")}`;
    ...
    images: [
      {
        ...
        alt: "Vender piso sin agencia en Madrid con Livendia",
      },
    ],
  },
};
