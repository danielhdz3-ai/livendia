      ...
      <main className="flex-1">
        ...
        <section className="mx-auto max-w-6xl px-4 py-14 sm:px-6">
          ...
          <p className="mt-2 max-w-3xl text-[#64748b]">
            Publicamos ciudad a ciudad cuando el texto está revisado y el JSON-LD coherente. Así Google y los usuarios encuentran contenido específico, no duplicados en masa sin matiz territorial.
          </p>
