...
import {
  PILLAR_BILBAO_CASE_STUDIES,
  PILLAR_BILBAO_COMPARE_ROWS,
  PILLAR_BILBAO_DOCUMENTS,
  PILLAR_BILBAO_FAQ,
  PILLAR_BILBAO_BILBAO_EXTRA,
  PILLAR_BILBAO_NEIGHBORHOODS,
  PILLAR_BILBAO_PATH,
  PILLAR_BILBAO_PROCESS,
  PILLAR_BILBAO_RELATED,
  PILLAR_BILBAO_RISKS,
  PILLAR_BILBAO_SAVINGS_ROWS,
  PILLAR_BILBAO_SECTIONS,
  PILLAR_BILBAO_TOC,
...
const WA_PREFILL =
  "Hola, estoy vendiendo mi piso en Bilbao entre particulares (sin comisiones) y quiero saber cómo funciona el servicio completo de venta Livendia.";
    ...
    "@graph": [
      {
        "@type": "Service",
        "@id": `${pageUrl}#service`,
        name: "Vender piso sin comisiones en Bilbao entre particulares con gestor legal Livendia",
        description:
          "Acompañamiento jurídico-documental para propietarios que venden en Bilbao sin inmobiliaria: contratos, documentación y coordinación hasta notaría.",
        serviceType: "Venta de vivienda entre particulares",
        provider: { "@type": "Organization", name: "Livendia", url: base },
        areaServed: {
          "@type": "City",
          name: "Bilbao",
          containedInPlace: { "@type": "AdministrativeArea", name: "País Vasco" },
        },
        offers: {
          "@type": "Offer",
          price: priceEur,
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: "Bilbao", item: pageUrl },
        ],
      },
      {
        "@type": "FAQPage",
...
function InlineCta({
    ...
    return (
      <aside className="my-8 rounded-xl border border-blue-200 bg-blue-50/80 p-5 text-center sm:p-6">
        <p className="text-sm font-semibold text-[#1E293B] sm:text-base">
          ¿Ya tienes comprador en Bilbao? Contrata gestoría por {SERVICIO_COMPLETO_CV_PRICE_LABEL} IVA incl. — sin
  ...
  return (
    <aside className="my-10 rounded-2xl bg-[#1E3A8A] p-6 text-center text-white sm:p-8">
      <p className="text-lg font-bold sm:text-xl">Vende entre particulares con gestor legal en Bilbao</p>
...
export async function VenderPisoSinInmobiliariaBilbaoPillarPage() {
  ...
  const priceLabelCompact = service
    ...
    : SERVICIO_COMPLETO_CV_PRICE_LABEL_COMPACT;
  const pageUrl = `${getSiteUrl()}${PILLAR_BILBAO_PATH}`;
  const waHref = `https://wa.me/${WA.replace(/\D/g, "")}?text=${encodeURIComponent(WA_PREFILL)}`;

  return (
    <ServicePurchaseProvider service={service}>
      <PillarJsonLd pageUrl={pageUrl} priceEur={priceEur} faq={PILLAR_BILBAO_FAQ} />
      <div className="flex min-h-screen flex-col bg-[#fafaf9]">
        ...
        <article className="flex-1">
            ...
            <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 sm:py-12 lg:py-16">
              <nav aria-label="Breadcrumb" className="mb-6 text-sm text-slate-500">
                <ol className="flex flex-wrap items-center justify-center gap-1 lg:justify-start">
                  ...
                  <ChevronRight className="mx-1 h-3.5 w-3.5" aria-hidden />
                  <li className="font-medium text-slate-800">Bilbao</li>
                </ol>
              </nav>
              ...
              <div className="grid items-center gap-8 lg:grid-cols-[1fr_min(100%,480px)] lg:gap-12 xl:grid-cols-[1fr_520px]">
                ...
                <VenderPisoSinInmobiliariaPillarHeroImage alt="Vender piso sin comisiones en Bilbao entre particulares con gestor legal Livendia" />
              </div>
            </div>
          </header>
          ...
          <div className="mx-auto max-w-3xl px-4 sm:px-6">
            ...
            <div className="pb-16 sm:pb-24">
                ...
                {PILLAR_BILBAO_SECTIONS.map((section, idx) => (
                ...
                <section id="proceso-completo" className="scroll-mt-24 border-b border-slate-100 py-10 text-center sm:py-12">
                  <h2 className="mx-auto max-w-2xl font-serif text-2xl font-bold text-[#0f172a] sm:text-3xl">
                    Proceso completo para vender piso directamente a un particular en Bilbao
                  </h2>
                  ...
                  <ol className="mt-8 space-y-6">
                    {PILLAR_BILBAO_PROCESS.map((step) => (
                      <li
                        key={step.title}
                  ...
                  <VenderPisoSinInmobiliariaSigningFigure city="Bilbao" />
                </section>

                {/* Documentación */}
                <section id="documentacion" className="scroll-mt-24 border-b border-slate-100 py-10 text-center sm:py-12">
                  <h2 className="mx-auto max-w-2xl font-serif text-2xl font-bold text-[#0f172a] sm:text-3xl">
                    Documentación necesaria para vender sin agencia en Bilbao
                  </h2>
                  <p className="mx-auto mt-4 max-w-2xl text-left text-base leading-relaxed text-slate-700">
                  ...
                  <div className="mt-8 overflow-x-auto rounded-xl border border-slate-200">
                    <table className="w-full min-w-[640px] text-left text-sm">
                      ...
                      <tbody className="divide-y divide-slate-100 bg-white">
                        {PILLAR_BILBAO_DOCUMENTS.map((doc) => (
                ...
                <section id="riesgos" className="scroll-mt-24 border-b border-slate-100 py-10 text-center sm:py-12">
                  ...
                  <p className="mx-auto mt-4 max-w-2xl text-left text-base leading-relaxed text-slate-700">
                    ...
                    Estos son los escenarios que más consultas generan en operaciones bilbaínas.
                  </p>
                  <ul className="mt-8 space-y-4">
                    {PILLAR_BILBAO_RISKS.map((r) => (
                ...
                <section id="comparativa" className="scroll-mt-24 border-b border-slate-100 py-10 text-center sm:py-12">
                  ...
                  <div className="mt-8 overflow-x-auto rounded-xl border border-slate-200 shadow-sm">
                    <table className="w-full min-w-[720px] text-left text-sm">
                      ...
                      <tbody className="divide-y divide-slate-100 bg-white">
                        {PILLAR_BILBAO_COMPARE_ROWS.map((row) => (
                          <tr key={row.aspect}>
                ...
                <section id="ahorro-comisiones" className="scroll-mt-24 border-b border-slate-100 py-10 text-center sm:py-12">
                  <h2 className="mx-auto max-w-2xl font-serif text-2xl font-bold text-[#0f172a] sm:text-3xl">
                    Cuánto puedes ahorrar en comisiones al vender sin inmobiliaria en Bilbao
                  </h2>
                  <p className="mx-auto mt-4 max-w-2xl text-left text-base leading-relaxed text-slate-700">
                  ...
                  <div className="mt-8 overflow-x-auto rounded-xl border border-slate-200">
                    <table className="w-full min-w-[600px] text-left text-sm">
                      ...
                      <tbody className="divide-y divide-slate-100 bg-white">
                        {PILLAR_BILBAO_SAVINGS_ROWS.map((row) => (
                          <tr key={row.price} className={row.price === 350_000 ? "bg-emerald-50/50" : undefined}>
                  ...
                  <p className="mt-4 text-left text-sm text-slate-500">
                    Ejemplo destacado: en un piso de 350.000 €, ahorras 11.815 € frente al 3 % + IVA o 20.285 € frente al
                    5 % + IVA.
                  </p>
                </section>

                {PILLAR_BILBAO_BILBAO_EXTRA.map((section) => (
                  <ProseSection key={section.id} id={section.id} title={section.title} paragraphs={section.paragraphs}>
                    {section.id === "bilbao-mercado" ? (
                      <div className="mt-6 text-center">
                        <p className="text-sm font-semibold text-slate-700">Barrios y municipios donde operamos en Bilbao:</p>
                        <ul className="mt-3 flex flex-wrap justify-center gap-2">
                          {PILLAR_BILBAO_NEIGHBORHOODS.map((z) => (
                            <li
                              key={z}
                ...
                <section id="casos-ejemplo" className="scroll-mt-24 border-b border-slate-100 py-10 text-center sm:py-12">
                  <h2 className="mx-auto max-w-2xl font-serif text-2xl font-bold text-[#0f172a] sm:text-3xl">
                    Ejemplos representativos de venta entre particulares en Bilbao
                  </h2>
                  <p className="mx-auto mt-4 max-w-2xl text-left text-base leading-relaxed text-slate-700">
                  ...
                  <div className="mt-8 space-y-6">
                    {PILLAR_BILBAO_CASE_STUDIES.map((c) => (
                ...
                <section id="servicios-relacionados" className="scroll-mt-24 border-b border-slate-100 py-10 text-center sm:py-12">
                  ...
                  <p className="mx-auto mt-4 max-w-2xl text-left text-base leading-relaxed text-slate-700">
                    Esta página es el <strong>pilar editorial</strong> para vender sin inmobiliaria en Bilbao. Desde
                    aquí enlazamos las fichas de servicio, otras landings locales y el hub nacional para compraventa
                    entre particulares.
                  </p>
                  <ul className="mt-8 grid gap-3 sm:grid-cols-2">
                    {PILLAR_BILBAO_RELATED.map((link) => (
                      <li key={link.href}>
                        <Link
                          href={link.href}
                ...
                <section id="preguntas-frecuentes" className="scroll-mt-24 py-10 text-center sm:py-12">
                  <h2 className="mx-auto max-w-2xl font-serif text-2xl font-bold text-[#0f172a] sm:text-3xl">
                    Preguntas frecuentes sobre vender sin comisiones en Bilbao
                  </h2>
                  ...
                  <div className="mx-auto flex max-w-2xl flex-col items-center gap-4">
                    ...
                    <div>
                      <h2 className="text-xl font-bold sm:text-2xl">
                        Vende tu piso en Bilbao entre particulares — con gestor legal, sin comisión del 3–5 %
                      </h2>
        ...
        <ServiceLandingSharedSections city="Bilbao" />
