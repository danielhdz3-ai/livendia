...
import {
  PILLAR_BARCELONA_BARCELONA_EXTRA,
  PILLAR_BARCELONA_CASE_STUDIES,
  PILLAR_BARCELONA_COMPARE_ROWS,
  PILLAR_BARCELONA_DOCUMENTS,
  PILLAR_BARCELONA_FAQ,
  PILLAR_BARCELONA_NEIGHBORHOODS,
  PILLAR_BARCELONA_PATH,
  PILLAR_BARCELONA_PROCESS,
  PILLAR_BARCELONA_RELATED,
  PILLAR_BARCELONA_RISKS,
  PILLAR_BARCELONA_SAVINGS_ROWS,
  PILLAR_BARCELONA_SECTIONS,
  PILLAR_BARCELONA_TOC,
...
const WA_PREFILL =
  "Hola, estoy vendiendo mi piso en Barcelona entre particulares (sin comisiones) y quiero saber cómo funciona el servicio completo de venta Livendia.";
    ...
    "@graph": [
      {
        "@type": "Service",
        "@id": `${pageUrl}#service`,
        name: "Vender piso sin comisiones en Barcelona entre particulares con gestor legal Livendia",
        description:
          "Acompañamiento jurídico-documental para propietarios que venden en Barcelona sin inmobiliaria: contratos, documentación y coordinación hasta notaría.",
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: "Barcelona", item: pageUrl },
        ],
      },
      {
        "@type": "FAQPage",
...
function InlineCta({
  ...
  if (variant === "subtle") {
    return (
      <aside className="my-8 rounded-xl border border-blue-200 bg-blue-50/80 p-5 sm:p-6">
        <p className="text-sm font-semibold text-[#1E293B] sm:text-base">
          ¿Ya tienes comprador en Barcelona? Contrata gestoría por {SERVICIO_COMPLETO_CV_PRICE_LABEL} IVA incl. — sin
...
function ProseSection({
  ...
  return (
    <section id={id} className="scroll-mt-24 border-b border-slate-100 py-10 sm:py-12">
      <h2 className="font-serif text-2xl font-bold leading-snug text-[#0f172a] sm:text-3xl">{title}</h2>
      <div className="mt-5 space-y-4 text-base leading-[1.75] text-slate-700 sm:text-[1.0625rem]">
        {paragraphs.map((p) => (
...
export async function VenderPisoSinInmobiliariaBarcelonaPillarPage() {
  ...
  const priceLabelCompact = service
    ...
    : SERVICIO_COMPLETO_CV_PRICE_LABEL_COMPACT;
  const pageUrl = `${getSiteUrl()}${PILLAR_BARCELONA_PATH}`;
  const waHref = `https://wa.me/${WA.replace(/\D/g, "")}?text=${encodeURIComponent(WA_PREFILL)}`;

  return (
    <ServicePurchaseProvider service={service}>
      <PillarJsonLd pageUrl={pageUrl} priceEur={priceEur} faq={PILLAR_BARCELONA_FAQ} />
      <div className="flex min-h-screen flex-col bg-[#fafaf9]">
        ...
        <article className="flex-1">
            ...
            <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 sm:py-12 lg:py-16">
              <nav aria-label="Breadcrumb" className="mb-6 text-sm text-slate-500">
                <ol className="flex flex-wrap items-center gap-1">
                  ...
                  <ChevronRight className="mx-1 h-3.5 w-3.5" aria-hidden />
                  <li className="font-medium text-slate-800">Barcelona</li>
                </ol>
              </nav>
          ...
          <div className="mx-auto max-w-6xl px-4 sm:px-6">
            <div className="lg:grid lg:grid-cols-[240px_1fr] lg:gap-12 lg:py-4">
              {/* Índice sticky */}
              <aside className="hidden lg:block">
                ...
                >
                  ...
                  <ul className="mt-4 space-y-2 text-sm">
                    {PILLAR_BARCELONA_TOC.map((item) => (
                      <li key={item.id}>
                        <a
                          href={`#${item.id}`}
                          className="block rounded-md px-2 py-1.5 text-slate-600 transition hover:bg-slate-50 hover:text-[#1A4FBF]"
                        >
                          {item.label}
                        </a>
                      </li>
              ...
              <div className="min-w-0 max-w-3xl pb-16 lg:max-w-none lg:pb-24">
                {/* Índice móvil */}
                <details className="my-6 rounded-xl border border-slate-200 bg-white p-4 lg:hidden">
                  <summary className="cursor-pointer text-sm font-semibold text-[#1E293B]">Índice de la guía</summary>
                ...
                {PILLAR_BARCELONA_SECTIONS.map((section, idx) => (
                ...
                <section id="proceso-completo" className="scroll-mt-24 border-b border-slate-100 py-10 sm:py-12">
                  <h2 className="font-serif text-2xl font-bold text-[#0f172a] sm:text-3xl">
                    Proceso completo para vender piso directamente a un particular en Barcelona
                  </h2>
                  ...
                  <ol className="mt-8 space-y-6">
                    {PILLAR_BARCELONA_PROCESS.map((step) => (
                      <li
                        key={step.title}
                ...
                {/* Documentación */}
                <section id="documentacion" className="scroll-mt-24 border-b border-slate-100 py-10 sm:py-12">
                  <h2 className="font-serif text-2xl font-bold text-[#0f172a] sm:text-3xl">
                    Documentación necesaria para vender sin agencia en Barcelona
                  </h2>
                  <p className="mt-4 text-base leading-relaxed text-slate-700">
                  ...
                  <div className="mt-8 overflow-x-auto rounded-xl border border-slate-200">
                    <table className="w-full min-w-[640px] text-left text-sm">
                      ...
                      <tbody className="divide-y divide-slate-100 bg-white">
                        {PILLAR_BARCELONA_DOCUMENTS.map((doc) => (
                ...
                {/* Riesgos */}
                <section id="riesgos" className="scroll-mt-24 border-b border-slate-100 py-10 sm:py-12">
                  <h2 className="font-serif text-2xl font-bold text-[#0f172a] sm:text-3xl">
                  ...
                  <p className="mt-4 text-base leading-relaxed text-slate-700">
                    ...
                    Estos son los escenarios que más consultas generan en operaciones barcelonesas.
                  </p>
                  <ul className="mt-8 space-y-4">
                    {PILLAR_BARCELONA_RISKS.map((r) => (
                ...
                {/* Comparativa */}
                <section id="comparativa" className="scroll-mt-24 border-b border-slate-100 py-10 sm:py-12">
                  <h2 className="font-serif text-2xl font-bold text-[#0f172a] sm:text-3xl">
                  ...
                  <div className="mt-8 overflow-x-auto rounded-xl border border-slate-200 shadow-sm">
                    <table className="w-full min-w-[720px] text-left text-sm">
                      ...
                      <tbody className="divide-y divide-slate-100 bg-white">
                        {PILLAR_BARCELONA_COMPARE_ROWS.map((row) => (
                          <tr key={row.aspect}>
                ...
                {/* Ahorro */}
                <section id="ahorro-comisiones" className="scroll-mt-24 border-b border-slate-100 py-10 sm:py-12">
                  <h2 className="font-serif text-2xl font-bold text-[#0f172a] sm:text-3xl">
                    Cuánto puedes ahorrar en comisiones al vender sin inmobiliaria en Barcelona
                  </h2>
                  <p className="mt-4 text-base leading-relaxed text-slate-700">
                  ...
                  <div className="mt-8 overflow-x-auto rounded-xl border border-slate-200">
                    <table className="w-full min-w-[600px] text-left text-sm">
                      ...
                      <tbody className="divide-y divide-slate-100 bg-white">
                        {PILLAR_BARCELONA_SAVINGS_ROWS.map((row) => (
                          <tr key={row.price} className={row.price === 400_000 ? "bg-emerald-50/50" : undefined}>
                  ...
                  <p className="mt-4 text-sm text-slate-500">
                    Ejemplo destacado: en un piso de 400.000 €, ahorras 13.630 € frente al 3 % + IVA o 23.310 € frente al
                    5 % + IVA.
                  </p>
                </section>

                {PILLAR_BARCELONA_BARCELONA_EXTRA.map((section) => (
                  <ProseSection key={section.id} id={section.id} title={section.title} paragraphs={section.paragraphs}>
                    {section.id === "barcelona-mercado" ? (
                      <div className="mt-6">
                        <p className="text-sm font-semibold text-slate-700">Zonas donde operamos con el mismo protocolo:</p>
                        <ul className="mt-3 flex flex-wrap gap-2">
                          {PILLAR_BARCELONA_NEIGHBORHOODS.map((z) => (
                            <li
                              key={z}
                ...
                {/* Casos ejemplo */}
                <section id="casos-ejemplo" className="scroll-mt-24 border-b border-slate-100 py-10 sm:py-12">
                  <h2 className="font-serif text-2xl font-bold text-[#0f172a] sm:text-3xl">
                    Ejemplos representativos de venta entre particulares en Barcelona
                  </h2>
                  <p className="mt-4 text-base leading-relaxed text-slate-700">
                  ...
                  <div className="mt-8 space-y-6">
                    {PILLAR_BARCELONA_CASE_STUDIES.map((c) => (
                ...
                <section id="servicios-relacionados" className="scroll-mt-24 border-b border-slate-100 py-10 sm:py-12">
                  <h2 className="font-serif text-2xl font-bold text-[#0f172a] sm:text-3xl">
                    Servicios Livendia y guías relacionadas
                  </h2>
                  <p className="mt-4 text-base leading-relaxed text-slate-700">
                    Esta página es el <strong>pilar editorial</strong> para vender sin inmobiliaria en Barcelona. Desde
                    aquí enlazamos las fichas de servicio, otras landings locales y el hub nacional para compraventa
                    entre particulares.
                  </p>
                  <ul className="mt-8 grid gap-3 sm:grid-cols-2">
                    {PILLAR_BARCELONA_RELATED.map((link) => (
                      <li key={link.href}>
                        <Link
                          href={link.href}
                ...
                {/* FAQ */}
                <section id="preguntas-frecuentes" className="scroll-mt-24 py-10 sm:py-12">
                  <h2 className="font-serif text-2xl font-bold text-[#0f172a] sm:text-3xl">
                    Preguntas frecuentes sobre vender sin comisiones en Barcelona
                  </h2>
                  <p className="mt-4 text-base text-slate-600">
                    Respuestas sobre venta entre particulares, trámites, ahorro y el papel de Livendia.
                  </p>
                  <ul className="mt-8 space-y-3">
                    {PILLAR_BARCELONA_FAQ.map((item) => (
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h2 className="text-xl font-bold sm:text-2xl">
                        Vende tu piso en Barcelona entre particulares — con gestor legal, sin comisión del 3–5 %
                      </h2>
