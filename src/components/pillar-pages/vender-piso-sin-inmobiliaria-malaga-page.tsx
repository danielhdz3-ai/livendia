...
const WA_PREFILL =
  "Hola, estoy vendiendo mi piso en Málaga entre particulares (sin comisiones) y quiero saber cómo funciona el servicio completo de venta Livendia.";
    ...
    "@graph": [
      {
        "@type": "Service",
        "@id": `${pageUrl}#service`,
        name: "Vender piso sin comisiones en Málaga entre particulares con gestor legal Livendia",
        description:
          "Acompañamiento jurídico-documental para propietarios que venden en Málaga sin inmobiliaria: contratos, documentación y coordinación hasta notaría.",
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: "Málaga", item: pageUrl },
        ],
      },
      {
        "@type": "FAQPage",
...
function InlineCta({
    ...
    return (
      <aside className="my-8 rounded-xl border border-blue-200 bg-blue-50/80 p-5 text-center sm:p-6">
        <p className="text-sm font-semibold text-[#1E293B] sm:text-base">
          ¿Ya tienes comprador en Málaga? Contrata gestoría por {SERVICIO_COMPLETO_CV_PRICE_LABEL} IVA incl. — sin
  ...
  return (
    <aside className="my-10 rounded-2xl bg-[#1E3A8A] p-6 text-center text-white sm:p-8">
      <p className="text-lg font-bold sm:text-xl">Vende entre particulares con gestor legal en Málaga</p>
...
export async function VenderPisoSinInmobiliariaMálagaPillarPage() {
        ...
        <article className="flex-1">
            ...
            <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 sm:py-12 lg:py-16">
              <nav aria-label="Breadcrumb" className="mb-6 text-sm text-slate-500">
                <ol className="flex flex-wrap items-center justify-center gap-1 lg:justify-start">
                  ...
                  <ChevronRight className="mx-1 h-3.5 w-3.5" aria-hidden />
                  <li className="font-medium text-slate-800">Málaga</li>
                </ol>
              </nav>
              ...
              <div className="grid items-center gap-8 lg:grid-cols-[1fr_min(100%,480px)] lg:gap-12 xl:grid-cols-[1fr_520px]">
                ...
                <VenderPisoSinInmobiliariaPillarHeroImage alt="Vender piso sin comisiones en Málaga entre particulares con gestor legal Livendia" />
              </div>
            </div>
          </header>
          ...
          <div className="mx-auto max-w-3xl px-4 sm:px-6">
            ...
            <div className="pb-16 sm:pb-24">
                ...
                {/* Plataforma cliente */}
                <ClientPlatformShowcase city="Malaga" />
                ...
                <section id="proceso-completo" className="scroll-mt-24 border-b border-slate-100 py-10 text-center sm:py-12">
                  <h2 className="mx-auto max-w-2xl font-serif text-2xl font-bold text-[#0f172a] sm:text-3xl">
                    Proceso completo para vender piso directamente a un particular en Málaga
                  </h2>
                  ...
                  <VenderPisoSinInmobiliariaSigningFigure city="Málaga" />
                </section>

                {/* Documentación */}
                <section id="documentacion" className="scroll-mt-24 border-b border-slate-100 py-10 text-center sm:py-12">
                  <h2 className="mx-auto max-w-2xl font-serif text-2xl font-bold text-[#0f172a] sm:text-3xl">
                    Documentación necesaria para vender sin agencia en Málaga
                  </h2>
                  <p className="mx-auto mt-4 max-w-2xl text-left text-base leading-relaxed text-slate-700">
                ...
                <section id="ahorro-comisiones" className="scroll-mt-24 border-b border-slate-100 py-10 text-center sm:py-12">
                  <h2 className="mx-auto max-w-2xl font-serif text-2xl font-bold text-[#0f172a] sm:text-3xl">
                    Cuánto puedes ahorrar en comisiones al vender sin inmobiliaria en Málaga
                  </h2>
                  <p className="mx-auto mt-4 max-w-2xl text-left text-base leading-relaxed text-slate-700">
                  ...
                  <ProseSection key={section.id} id={section.id} title={section.title} paragraphs={section.paragraphs}>
                    {section.id === "malaga-mercado" ? (
                      <div className="mt-6 text-center">
                        <p className="text-sm font-semibold text-slate-700">Barrios y municipios donde operamos en Málaga:</p>
                ...
                <section id="casos-ejemplo" className="scroll-mt-24 border-b border-slate-100 py-10 text-center sm:py-12">
                  <h2 className="mx-auto max-w-2xl font-serif text-2xl font-bold text-[#0f172a] sm:text-3xl">
                    Ejemplos representativos de venta entre particulares en Málaga
                  </h2>
                  <p className="mx-auto mt-4 max-w-2xl text-left text-base leading-relaxed text-slate-700">
                ...
                <section id="servicios-relacionados" className="scroll-mt-24 border-b border-slate-100 py-10 text-center sm:py-12">
                  ...
                  <p className="mx-auto mt-4 max-w-2xl text-left text-base leading-relaxed text-slate-700">
                    Esta página es el <strong>pilar editorial</strong> para vender sin inmobiliaria en Málaga. Desde
                ...
                <section id="preguntas-frecuentes" className="scroll-mt-24 py-10 text-center sm:py-12">
                  <h2 className="mx-auto max-w-2xl font-serif text-2xl font-bold text-[#0f172a] sm:text-3xl">
                    Preguntas frecuentes sobre vender sin comisiones en Málaga
                  </h2>
                  ...
                  <div className="mx-auto flex max-w-2xl flex-col items-center gap-4">
                    ...
                    <div>
                      <h2 className="text-xl font-bold sm:text-2xl">
                        Vende tu piso en Málaga entre particulares — con gestor legal, sin comisión del 3–5 %
                      </h2>
