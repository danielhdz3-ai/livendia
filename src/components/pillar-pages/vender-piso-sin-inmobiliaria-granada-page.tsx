...
import {
  PILLAR_GRANADA_CASE_STUDIES,
  PILLAR_GRANADA_COMPARE_ROWS,
  PILLAR_GRANADA_DOCUMENTS,
  PILLAR_GRANADA_FAQ,
  PILLAR_GRANADA_GRANADA_EXTRA,
  PILLAR_GRANADA_NEIGHBORHOODS,
  PILLAR_GRANADA_PATH,
  PILLAR_GRANADA_PROCESS,
  PILLAR_GRANADA_RELATED,
  PILLAR_GRANADA_RISKS,
  PILLAR_GRANADA_SAVINGS_ROWS,
  PILLAR_GRANADA_SECTIONS,
  PILLAR_GRANADA_TOC,
...
const WA_PREFILL =
  "Hola, estoy vendiendo mi piso en Granada entre particulares (sin comisiones) y quiero saber cómo funciona el servicio completo de venta Livendia.";
    ...
    "@graph": [
      {
        "@type": "Service",
        "@id": `${pageUrl}#service`,
        name: "Vender piso sin comisiones en Granada entre particulares con gestor legal Livendia",
        description:
          "Acompañamiento jurídico-documental para propietarios que venden en Granada sin inmobiliaria: contratos, documentación y coordinación hasta notaría.",
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: "Granada", item: pageUrl },
        ],
      },
      {
        "@type": "FAQPage",
...
function InlineCta({
    ...
    return (
      <aside className="my-8 rounded-xl border border-blue-200 bg-blue-50/80 p-5 text-center sm:p-6">
        <p className="text-sm font-semibold text-[#1E293B] sm:text-base">
          ¿Ya tienes comprador en Granada? Contrata gestoría por {SERVICIO_COMPLETO_CV_PRICE_LABEL} IVA incl. — sin
  ...
  return (
    <aside className="my-10 rounded-2xl bg-[#1E3A8A] p-6 text-center text-white sm:p-8">
      <p className="text-lg font-bold sm:text-xl">Vende entre particulares con gestor legal en Granada</p>
...
export async function VenderPisoSinInmobiliariaGranadaPillarPage() {
  ...
  const priceLabelCompact = service
    ...
    : SERVICIO_COMPLETO_CV_PRICE_LABEL_COMPACT;
  const pageUrl = `${getSiteUrl()}${PILLAR_GRANADA_PATH}`;
  const waHref = `https://wa.me/${WA.replace(/\D/g, "")}?text=${encodeURIComponent(WA_PREFILL)}`;

  return (
    <ServicePurchaseProvider service={service}>
      <PillarJsonLd pageUrl={pageUrl} priceEur={priceEur} faq={PILLAR_GRANADA_FAQ} />
      <div className="flex min-h-screen flex-col bg-[#fafaf9]">
            ...
            <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 sm:py-12 lg:py-16">
              <nav aria-label="Breadcrumb" className="mb-6 text-sm text-slate-500">
                <ol className="flex flex-wrap items-center justify-center gap-1 lg:justify-start">
                  ...
                  <ChevronRight className="mx-1 h-3.5 w-3.5" aria-hidden />
                  <li className="font-medium text-slate-800">Granada</li>
                </ol>
              </nav>
              ...
              <div className="grid items-center gap-8 lg:grid-cols-[1fr_min(100%,480px)] lg:gap-12 xl:grid-cols-[1fr_520px]">
                ...
                <VenderPisoSinInmobiliariaPillarHeroImage alt="Vender piso sin comisiones en Granada entre particulares con gestor legal Livendia" />
              </div>
            </div>
          </header>
          ...
          <div className="mx-auto max-w-3xl px-4 sm:px-6">
            ...
            >
              <p className="flex items-center justify-center gap-2 text-xs font-bold uppercase tracking-wide text-slate-500">
                ...
                En esta guía — Granada
              </p>
              <ul className="mt-4 grid grid-cols-1 gap-2 text-sm sm:grid-cols-2">
                {PILLAR_GRANADA_TOC.map((item) => (
                  <li key={item.id}>
                    <a
                      href={`#${item.id}`}
            ...
            <div className="pb-16 sm:pb-24">
                ...
                {PILLAR_GRANADA_SECTIONS.map((section, idx) => (
                ...
                <section id="proceso-completo" className="scroll-mt-24 border-b border-slate-100 py-10 text-center sm:py-12">
                  <h2 className="mx-auto max-w-2xl font-serif text-2xl font-bold text-[#0f172a] sm:text-3xl">
                    Proceso completo para vender piso directamente a un particular en Granada
                  </h2>
                  ...
                  <ol className="mt-8 space-y-6">
                    {PILLAR_GRANADA_PROCESS.map((step) => (
                      <li
                        key={step.title}
                  ...
                  <VenderPisoSinInmobiliariaSigningFigure city="Granada" />
                </section>

                {/* Documentación */}
                <section id="documentacion" className="scroll-mt-24 border-b border-slate-100 py-10 text-center sm:py-12">
                  <h2 className="mx-auto max-w-2xl font-serif text-2xl font-bold text-[#0f172a] sm:text-3xl">
                    Documentación necesaria para vender sin agencia en Granada
                  </h2>
                  <p className="mx-auto mt-4 max-w-2xl text-left text-base leading-relaxed text-slate-700">
                  ...
                  <div className="mt-8 overflow-x-auto rounded-xl border border-slate-200">
                    <table className="w-full min-w-[640px] text-left text-sm">
                      ...
                      <tbody className="divide-y divide-slate-100 bg-white">
                        {PILLAR_GRANADA_DOCUMENTS.map((doc) => (
                ...
                <section id="riesgos" className="scroll-mt-24 border-b border-slate-100 py-10 text-center sm:py-12">
                  ...
                  <p className="mx-auto mt-4 max-w-2xl text-left text-base leading-relaxed text-slate-700">
                    ...
                    Estos son los escenarios que más consultas generan en operaciones granadanas.
                  </p>
                  <ul className="mt-8 space-y-4">
                    {PILLAR_GRANADA_RISKS.map((r) => (
                ...
                <section id="comparativa" className="scroll-mt-24 border-b border-slate-100 py-10 text-center sm:py-12">
                  ...
                  <div className="mt-8 overflow-x-auto rounded-xl border border-slate-200 shadow-sm">
                    <table className="w-full min-w-[720px] text-left text-sm">
                      ...
                      <tbody className="divide-y divide-slate-100 bg-white">
                        {PILLAR_GRANADA_COMPARE_ROWS.map((row) => (
                          <tr key={row.aspect}>
                ...
                <section id="ahorro-comisiones" className="scroll-mt-24 border-b border-slate-100 py-10 text-center sm:py-12">
                  <h2 className="mx-auto max-w-2xl font-serif text-2xl font-bold text-[#0f172a] sm:text-3xl">
                    Cuánto puedes ahorrar en comisiones al vender sin inmobiliaria en Granada
                  </h2>
                  <p className="mx-auto mt-4 max-w-2xl text-left text-base leading-relaxed text-slate-700">
                  ...
                  <div className="mt-8 overflow-x-auto rounded-xl border border-slate-200">
                    <table className="w-full min-w-[600px] text-left text-sm">
                      ...
                      <tbody className="divide-y divide-slate-100 bg-white">
                        {PILLAR_GRANADA_SAVINGS_ROWS.map((row) => (
                          <tr key={row.price} className={row.price === 220000 ? "bg-emerald-50/50" : undefined}>
                  ...
                  <p className="mt-4 text-left text-sm text-slate-500">
                    Ejemplo destacado: en un piso de 220.000 €, ahorras 7.986 € frente al 3 % + IVA o 13.310 € frente al
                    5 % + IVA.
                  </p>
                </section>

                {PILLAR_GRANADA_GRANADA_EXTRA.map((section) => (
                  <ProseSection key={section.id} id={section.id} title={section.title} paragraphs={section.paragraphs}>
                    {section.id === "granada-mercado" ? (
                      <div className="mt-6 text-center">
                        <p className="text-sm font-semibold text-slate-700">Barrios y municipios donde operamos en Granada:</p>
                        <ul className="mt-3 flex flex-wrap justify-center gap-2">
                          {PILLAR_GRANADA_NEIGHBORHOODS.map((z) => (
                            <li
                              key={z}
                ...
                <section id="casos-ejemplo" className="scroll-mt-24 border-b border-slate-100 py-10 text-center sm:py-12">
                  <h2 className="mx-auto max-w-2xl font-serif text-2xl font-bold text-[#0f172a] sm:text-3xl">
                    Ejemplos representativos de venta entre particulares en Granada
                  </h2>
                  <p className="mx-auto mt-4 max-w-2xl text-left text-base leading-relaxed text-slate-700">
                  ...
                  <div className="mt-8 space-y-6">
                    {PILLAR_GRANADA_CASE_STUDIES.map((c) => (
                ...
                <section id="servicios-relacionados" className="scroll-mt-24 border-b border-slate-100 py-10 text-center sm:py-12">
                  ...
                  <p className="mx-auto mt-4 max-w-2xl text-left text-base leading-relaxed text-slate-700">
                    Esta página es el <strong>pilar editorial</strong> para vender sin inmobiliaria en Granada. Desde
                    aquí enlazamos las fichas de servicio, otras landings locales y el hub nacional para compraventa
                    entre particulares.
                  </p>
                  <ul className="mt-8 grid gap-3 sm:grid-cols-2">
                    {PILLAR_GRANADA_RELATED.map((link) => (
                      <li key={link.href}>
                        <Link
                          href={link.href}
                ...
                <section id="preguntas-frecuentes" className="scroll-mt-24 py-10 text-center sm:py-12">
                  <h2 className="mx-auto max-w-2xl font-serif text-2xl font-bold text-[#0f172a] sm:text-3xl">
                    Preguntas frecuentes sobre vender sin comisiones en Granada
                  </h2>
                ...
                {/* CTA final */}
                <footer className="mt-4 rounded-2xl border border-[#1A4FBF]/20 bg-gradient-to-br from-[#1E3A8A] to-[#2563EB] p-8 text-center text-white sm:p-10">
                  <div className="mx-auto flex max-w-2xl flex-col items-center gap-4">
                    <FileText className="h-10 w-10 shrink-0 text-cyan-200" aria-hidden />
                    <div>
                      <h2 className="text-xl font-bold sm:text-2xl">
                        Vende tu piso en Granada entre particulares — con gestor legal, sin comisión del 3–5 %
                      </h2>
        ...
        <ServiceLandingSharedSections city="Granada" />
