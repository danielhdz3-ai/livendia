...
export function HomeSitelinksNav() {
  ...
  const mobileLinks = SITE_SITELINKS.filter((item) => MOBILE_PRIORITY_PATHS.has(item.path));
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <p className="text-center text-xs font-bold uppercase tracking-wider text-[#64748b]">
        ...
        {/* Móvil: chips deslizables, menos ruido visual */}
        ...
        {/* Tablet/desktop: todos los sitelinks */}
