  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <div className="mt-6 rounded-2xl bg-[#EFF6FF]/70 p-5 ring-1 ring-[#1A4FBF]/15 sm:p-6">
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mx-auto mt-10 max-w-3xl rounded-2xl border border-[#1A4FBF]/25 bg-white px-6 py-5 shadow-sm sm:flex sm:items-center sm:justify-between sm:gap-6">
          <div>
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-2">
          {steps.map((s) => (
            <span
              key={s.step}
              className="rounded-full border border-[#1A4FBF]/30 bg-white px-4 py-2 text-sm font-semibold text-[#1A4FBF]"
            >
              Paso {s.step}
            </span>
          ))}
