...
export function AdministracionAlquilerTemporadaLocalCityLinks({ currentSlug, className = "" }: Props) {
  const cities = getPublishedAdministracionAlquilerTemporadaLocalCities();

  return (
    <nav
      aria-label="Administración temporada y habitaciones por ciudad"
