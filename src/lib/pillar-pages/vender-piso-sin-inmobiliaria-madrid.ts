/**
 * Contenido pilar editorial — /vender-piso-sin-inmobiliaria/madrid
 */
...
export const PILLAR_MADRID_META = {
  ...
  keywords: [
    ...
    "vender vivienda entre particulares madrid",
    "vender piso directamente a un particular madrid",
    "ahorrar comisión inmobiliaria madrid",
    "vender casa sin agencia madrid",
    "vender piso sin agencia madrid",
    "venta entre particulares madrid",
    "vender piso de particular a particular madrid",
    "trámites vender piso particular madrid",
  ],
} as const;

export const PILLAR_MADRID_TOC = [
  ...
  { id: "madrid-mercado", label: "Vender en Madrid" },
...
export const PILLAR_MADRID_SECTIONS: readonly PillarSection[] = [
  {
    id: "por-que-vender-sin-inmobiliaria",
    title: "Por qué cada vez más propietarios en Madrid venden sin inmobiliaria",
    paragraphs: [
      "Vender un piso en Madrid sin inmobiliaria deja de ser una excepción: en la Comunidad de Madrid, donde el precio medio de la vivienda usada supera con frecuencia los 450.000 € en la capital, una comisión del 3 % más IVA representa más de 16.000 € y al 5 % se acerca a los 27.000 €. Ese importe no cubre la escritura ni el notario; es el coste de intermediar cuando tú ya has encontrado al comprador.",
      ...
      "En Madrid capital y corredor del Henares el comprador suele llegar con preaprobación bancaria. Entidades con sede en Paseo de la Castellana, Azca o Nuevos Ministerios exigen arras formalizadas y documentación impecable de la comunidad. El vendedor que vende sin agencia pero con orden documental cierra en plazos similares a una operación intermediada.",
      "Esta guía está pensada para ti si ya tienes comprador o lo estás negociando por tu cuenta y quieres ahorrar la comisión inmobiliaria sin asumir riesgos innecesarios. Aquí encontrarás el proceso completo en Madrid, la documentación exigida, los errores más caros y cómo encaja Livendia.",
    ],
  },
  {
    id: "que-es-venta-entre-particulares",
    title: "Qué significa vender vivienda entre particulares en Madrid (y qué no implica)",
    paragraphs: [
      ...
      "En Madrid, la venta sin agencia suele combinar: (1) captación del comprador por el propietario, (2) negociación directa del precio y calendario, y (3) acompañamiento jurídico-documental profesional. Livendia ocupa exclusivamente esta tercera pieza.",
      "Confundir «sin inmobiliaria» con «sin profesionales» es el error más repetido en operaciones en Chamberí, Salamanca o Vallecas. Puedes vender casa sin agencia y contratar gestoría especializada en compraventa entre particulares. Eso no convierte la operación en venta «con agencia».",
    ],
  },
  {
    id: "que-hace-livendia",
    title: "Qué hace Livendia cuando vendes sin inmobiliaria en Madrid — y qué no hace",
    paragraphs: [
      ...
      "Vender piso sin comisiones con Livendia significa pagar gestoría profesional, no porcentaje de agencia sobre los cientos de miles de euros de tu vivienda en Madrid.",
    ],
  },
];

export const PILLAR_MADRID_PROCESS: readonly PillarProcessStep[] = [
  {
    phase: "Fase 1",
    title: "Preparar la vivienda y el precio en Madrid",
    duration: "1–4 semanas",
    body: "Acota un precio realista según comparables en tu barrio —Salamanca, Chamberí, Tetuán, Carabanchel, Vallecas—, estado de la vivienda y situación registral. Reúne el certificado de eficiencia energética y la escritura. Si hay inquilino, revisa el contrato y plazos de desalojo.",
  ...
  },
  {
    ...
    duration: "Variable",
    body: "Publicas en portales, redes o cierras con alguien de tu entorno. Filtras solvencia: financiación, señal y plazos. En Madrid es habitual que el comprador pida segunda visita con técnico; no aceptes condiciones abusivas en caliente.",
  ...
  },
  {
    ...
    body: "Muchas operaciones entre particulares en Madrid arrancan con reserva: fija precio, plazo para arras, devolución si falla la hipoteca y penalizaciones por desistimiento.",
    livendiaRole: "Redacción del contrato de reserva adaptado a vuestra operación en la Comunidad de Madrid.",
  },
  {
    phase: "Fase 4",
  ...
  },
  {
    ...
    body: "Si vendes con hipoteca pendiente, coordina con tu banco provisión de fondos o subrogación. En Madrid esto es rutinario pero delicado en plazos.",
  ...
  },
  {
    ...
    body: "Plusvalía municipal, IRPF por ganancia patrimonial y gastos locales. El comprador asume ITP en segunda mano. Madrid capital y municipios del cinturón tienen normativas y bonificaciones propias.",
...
export const PILLAR_MADRID_DOCUMENTS: readonly PillarDocument[] = [
  {
  ...
  },
  {
    ...
    whyItMatters: "Imprescindible para hipoteca del comprador. Derramas en curso son causa frecuente de retraso en Madrid.",
  },
  {
  ...
  },
  {
    ...
    whyItMatters: "Núcleo de la seguridad jurídica entre particulares en Madrid.",
  },
  {
    name: "Certificados de instalaciones / ITE (si aplica)",
    whoProvides: "Según edificio",
    whyItMatters: "En edificios del centro, Chamberí o Salamanca antiguos, comprador o banco pueden exigirlos.",
  },
  {
    name: "Licencia de primera ocupación o cédula (obra nueva o reforma)",
    whoProvides: "Según caso",
    whyItMatters: "En promociones recientes de Vallecas, Vicálvaro o Ensanche de Vallecas puede ser requisito del comprador.",
  },
];

export const PILLAR_MADRID_RISKS: readonly PillarRisk[] = [
  {
  ...
  },
  {
    ...
    alone: "Conflictos el día de la firma en la notaría de Madrid.",
    withLivendia: "Revisión y alineación entre contratos privados y escritura.",
  },
];

export const PILLAR_MADRID_COMPARE_ROWS = [
  { aspect: "Coste en piso de 450.000 €", agency: "16.335–27.225 € (3–5 % + IVA)", alone: "0 € de gestoría", livendia: `${SERVICIO_COMPLETO_CV_PRICE_LABEL} IVA incl.` },
...
export const PILLAR_MADRID_SAVINGS_ROWS = [
  ...
  { price: 600_000, agency3: 21_780, agency5: 36_300, livendia: SERVICIO_COMPLETO_CV_PRICE_EUR },
  { price: 750_000, agency3: 27_225, agency5: 45_375, livendia: SERVICIO_COMPLETO_CV_PRICE_EUR },
] as const;

export const PILLAR_MADRID_CASE_STUDIES: readonly PillarCaseStudy[] = [
  {
    title: "Piso en Salamanca vendido a compañero de trabajo",
    scenario: "Propietario con piso de 90 m² en barrio Salamanca. Comprador de su empresa. Precio: 485.000 €.",
    challenge: "Comprador con hipoteca en entidad de Castellana. Banco exigía arras con suspensión a 60 días y certificado de comunidad sin derramas.",
    outcome: "Livendia redactó arras, ordenó documentación y alineó calendario con la entidad. Escritura en 10 semanas.",
    savings: "Frente a agencia al 3 % + IVA: ahorro de 14.445 € (15.335 € menos 890 € Livendia).",
  },
  {
    title: "Vivienda en Chamartín entre familiares",
    scenario: "Piso de 78 m² en Ciudad Jardín. Venta a sobrino. Precio: 410.000 €.",
    ...
    savings: "Frente al 5 % + IVA: ahorro de 20.285 €.",
  },
  {
    title: "Piso en Vallecas con hipoteca pendiente",
    scenario: "Propietario en Puente de Vallecas vende a 295.000 €. Hipoteca pendiente de 98.000 €.",
    ...
    savings: "Frente al 3 % + IVA: ahorro de 9.925 €.",
  },
];

export const PILLAR_MADRID_MADRID_EXTRA: readonly PillarSection[] = [
  {
    id: "financiacion-comprador",
    title: "Si el comprador necesita hipoteca en Madrid: qué debe saber el vendedor",
    paragraphs: [
      "La mayoría de compradores particulares en Madrid financian con préstamo hipotecario. Para el vendedor que ahorra comisión inmobiliaria entra en juego el banco del comprador, el tasador y plazos estrictos de documentación.",
      "Entidades con oficinas en Castellana, Azca o Nuevos Ministerios piden arras firmadas, certificado de comunidad, nota simple reciente, CEE e IBI al día. Si entregaste señal sin papeles, el comprador puede usar el retraso bancario para renegociar.",
      "Las cláusulas suspensivas en arras protegen a ambas partes: el comprador solicita hipoteca en plazo; si no la obtiene, se establece qué pasa con la señal. Mal redactadas u omitidas, son la causa más frecuente de disputas en ventas entre particulares en Madrid.",
  ...
  {
    id: "madrid-mercado",
    title: "Particularidades de vender en Madrid capital y área metropolitana",
    paragraphs: [
      "Madrid no es un mercado único. Vender sin inmobiliaria en Salamanca, Tetuán, Carabanchel o Vallecas implica compradores con perfiles distintos —familias, inversores, funcionarios en traslado— y tiempos de cierre variables.",
      "En el cinturón —Getafe, Móstoles, Leganés, Alcobendas, Fuenlabrada— los precios son más bajos pero el proceso legal es idéntico: arras, comunidad, ITP del comprador y plusvalía del vendedor. Livendia aplica el mismo protocolo y tarifa plana.",
      "La Comunidad de Madrid y el Ayuntamiento han ido ajustando requisitos de eficiencia energética y urbanismo. Si hubo reforma sin licencia o cambio de uso, conviene resolverlo antes de arras.",
      ...
      "Si vendes para comprar otro piso en Madrid, el calendario encadenado requiere arras bien redactadas en ambas patas. Livendia coordina la venta; para la compra existe el servicio completo de compra con la misma filosofía.",
    ],
  },
  {
    id: "errores-frecuentes",
    title: "Errores frecuentes al vender sin agencia en Madrid",
    paragraphs: [
      "Confundir interés con solvencia: en Madrid no faltan visitas; faltan compradores que obtengan hipoteca. Filtra antes de reservar y exige preaprobación cuando sea razonable.",
  ...
  },
  {
    ...
    title: "Livendia frente a inmobiliarias sin comisiones y gestoría tradicional en Madrid",
    paragraphs: [
      ...
      "Una gestoría de barrio en Madrid puede redactar contratos, pero rara vez está especializada en compraventa P2P con panel online y gestor dedicado por expediente.",
...
export const PILLAR_MADRID_FAQ: readonly PillarFaq[] = [
  {
    question: "¿Es legal vender mi piso en Madrid sin inmobiliaria?",
  ...
  {
    question: "¿Cuánto cuesta vender con Livendia frente a una agencia en Madrid?",
    answer: `El servicio completo cuesta ${SERVICIO_COMPLETO_CV_PRICE_LABEL} IVA incluido. En un piso de 450.000 €, una agencia al 3 % + IVA cobra unos 16.335 €; al 5 %, unos 27.225 €.`,
  },
  {
  ...
  {
    question: "¿Arras penitenciales o confirmatorias en Madrid?",
  ...
  },
  {
    ...
    answer: "Sí. Existe contrato de arras local en Madrid. Si ya firmaste arras, está la gestión documental vendedor. El servicio completo es lo habitual de reserva a notaría.",
  },
  {
  ...
  {
    question: "¿Cuánto tarda una venta entre particulares en Madrid?",
  ...
  {
    question: "¿Sirve esta guía si vendo en Getafe o Móstoles?",
    answer: "Sí. El marco legal es estatal. Livendia cubre Madrid capital y área metropolitana con el mismo servicio y tarifa.",
  },
  {
  ...
  {
    question: "¿Esta página sustituye a vender piso sin agencia Madrid?",
    answer: "Esta es la guía pilar más completa. La landing en /servicios/vender-piso-sin-agencia-madrid sigue activa como ficha complementaria.",
  },
];

export const PILLAR_MADRID_RELATED: readonly PillarRelatedLink[] = [
  {
  ...
  {
    href: "/servicios/servicio-completo-venta-local/madrid",
    label: "Servicio completo de venta en Madrid",
    description: "Landing de conversión local enlazada desde esta guía.",
    category: "local",
  },
  {
    href: "/servicios/contrato-arras-local/madrid",
    label: "Contrato de arras en Madrid",
    description: "Si solo necesitas arras con revisión legal.",
    category: "servicio",
  },
  {
    href: "/servicios/gestion-documental-vendedor/madrid",
    label: "Gestión documental vendedor Madrid",
    description: "Después de arras: documentación hacia escritura.",
    category: "servicio",
  },
  {
    href: "/gestoria/madrid",
    label: "Gestoría inmobiliaria Madrid",
    description: "Todos los servicios Livendia en la capital.",
    category: "local",
  },
  {
    href: "/servicios/vender-piso-sin-agencia-madrid",
    label: "Vender piso sin agencia Madrid",
  ...
  },
  {
    ...
    label: "Comprar piso entre particulares en Madrid",
    description: "Para propietarios que venden y compran en cadena.",
    category: "local",
  },
];

export const PILLAR_MADRID_NEIGHBORHOODS = [
  "Salamanca",
  "Chamberí",
  "Retiro",
  "Chamartín",
