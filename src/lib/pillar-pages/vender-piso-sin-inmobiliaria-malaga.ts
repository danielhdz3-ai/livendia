/**
 * Contenido pilar editorial — /vender-piso-sin-inmobiliaria/malaga
 */
...
export const PILLAR_MALAGA_META = {
  title: "Vender piso sin comisiones en Málaga | Entre particulares con gestor legal | Livendia",
  description:
  ...
  keywords: [
    ...
    "vender vivienda entre particulares malaga",
    "vender piso directamente a un particular malaga",
    "ahorrar comisión inmobiliaria malaga",
    "vender casa sin agencia malaga",
    "vender piso sin agencia malaga",
    "venta entre particulares malaga",
    "vender piso de particular a particular malaga",
    "trámites vender piso particular malaga",
  ],
} as const;

export const PILLAR_MALAGA_TOC = [
...
export const PILLAR_MALAGA_DOCUMENTS: readonly PillarDocument[] = [
  {
...
export const PILLAR_MALAGA_RISKS: readonly PillarRisk[] = [
  {
