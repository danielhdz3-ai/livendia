...
export const ADMINISTRACION_ALQUILER_BARCELONA_METRO_LANDINGS = [
  ...
  {
    slug: "born",
    segments: ["barcelona", "born"] as const,
  ...
  {
    slug: "vila-olimpica",
    segments: ["barcelona", "vila-olimpica"] as const,
    name: "Vila Olímpica, Barcelona",
    shortName: "Vila Olímpica",
    kind: "subbarrio" as const,
  },
  {
    slug: "gotic",
    segments: ["barcelona", "gotic"] as const,
    name: "Barri Gòtic, Barcelona",
    shortName: "Barri Gòtic",
    kind: "subbarrio" as const,
  },
  {
    slug: "barceloneta",
    segments: ["barcelona", "barceloneta"] as const,
    name: "La Barceloneta, Barcelona",
    shortName: "La Barceloneta",
    kind: "subbarrio" as const,
  },
  {
    slug: "sarria",
    segments: ["barcelona", "sarria"] as const,
    name: "Sarrià, Barcelona",
    shortName: "Sarrià",
    kind: "subbarrio" as const,
  },
  {
    slug: "vila-de-gracia",
    segments: ["barcelona", "vila-de-gracia"] as const,
    name: "Vila de Gràcia, Barcelona",
