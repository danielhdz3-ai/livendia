...
/** Compra (venta Stripe / /gracias). */
export const GOOGLE_ADS_CONVERSION_PURCHASE = `${GOOGLE_ADS_ID_DEFAULT}/YAx6CPuH_O4cEL-e2fBD`;
/** Envío de formulario — Revisón Post-Arras BCN (manual). */
export const GOOGLE_ADS_CONVERSION_LEAD = `${GOOGLE_ADS_ID_DEFAULT}/Vd6LCKqum_AcEL-e2fBD`;
