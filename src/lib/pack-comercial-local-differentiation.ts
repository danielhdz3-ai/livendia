...
export const PACK_ARRAS_GESTION_LOCAL_DIFFERENTIATION: Record<string, LocalCityLandingFields> = {
  ...
  barcelona: {
    ...
    localZones:
      "Barcelona ciudad y área metropolitana: Eixample, Gràcia, Les Corts, Ciutat Vella, Sarrià-Sant Gervasi, Sant Martí, Nou Barris, Horta-Guinardó, Sant Andreu, Born, Poblenou, Gòtic, Sarrià, Raval, Sants-Montjuïc, L'Hospitalet, Badalona, Cornellà, Esplugues, Sant Joan Despí, Sant Adrià, Castelldefels, Sant Boi, Gavà, Mollet, Sant Cugat, Sabadell y Terrassa. Landings del pack por barrio y municipio. Normativa catalana cubierta por gestor Livendia.",
    heroImage: "/images/barcelona.jpg",
