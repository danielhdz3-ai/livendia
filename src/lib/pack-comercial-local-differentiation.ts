...
export const PACK_ARRAS_GESTION_LOCAL_DIFFERENTIATION: Record<string, LocalCityLandingFields> = {
  ...
  barcelona: {
    ...
    localZones:
      "Barcelona ciudad y área metropolitana: Eixample, Gràcia, Les Corts, El Born, Poblenou, Gòtic, Sarrià, Raval, Barceloneta, Vila Olímpica, Sants-Montjuïc, L'Hospitalet y Badalona. Landings del pack por barrio. Normativa catalana cubierta por gestor Livendia.",
    heroImage: "/images/barcelona.jpg",
