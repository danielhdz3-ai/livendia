...
export const ADMINISTRACION_ALQUILER_MONTHLY_PRICE_EUR = 59;
export const ADMINISTRACION_ALQUILER_MONTHLY_PRICE_CENTS =
  ADMINISTRACION_ALQUILER_MONTHLY_PRICE_EUR * 100;
...
export const ACOMPANAMIENTO_RESERVA_ARRAS_PRICE_LABEL = `${ACOMPANAMIENTO_RESERVA_ARRAS_PRICE_EUR} €`;
export const ACOMPANAMIENTO_RESERVA_ARRAS_SLUG = "acompanamiento-reserva-arras" as const;
