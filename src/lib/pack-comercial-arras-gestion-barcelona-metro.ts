...
import {
  PACK_ARRAS_GESTION_BCN_METRO_BATCH4,
  PACK_ARRAS_GESTION_BCN_METRO_BATCH4_SLUGS,
} from "@/lib/pack-comercial-arras-gestion-barcelona-metro-zones-batch4";
import {
  PACK_ARRAS_GESTION_BCN_METRO_BATCH5,
  PACK_ARRAS_GESTION_BCN_METRO_BATCH5_SLUGS,
} from "@/lib/pack-comercial-arras-gestion-barcelona-metro-zones-batch5";
