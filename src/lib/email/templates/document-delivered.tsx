...
/** Cuando la gestoría suba el documento final (uso futuro). */
export function DocumentDeliveredEmail({
  customerName,
  serviceName,
  message,
  dashboardUrl,
  ...
  return (
    <Html>
      <Head />
      <Preview>Documento disponible — {serviceName}</Preview>
      <Body style={body}>
        <Container style={card}>
          ...
          <Section style={inner}>
            <Heading style={h1}>Tienes un documento listo</Heading>
            <Text style={p}>Hola {customerName || "cliente"},</Text>
            <Text style={p}>
              Respecto a <strong>{serviceName}</strong>: {message}
            </Text>
...
export default DocumentDeliveredEmail;
