...
export function WelcomeEmail({ customerName, dashboardUrl }: Props) {
  return (
    <Html>
      <Head />
      <Preview>Bienvenido/a a Livendia</Preview>
      <Body style={body}>
        <Container style={card}>
          ...
          <Section style={inner}>
            ...
            <Text style={p}>
              Tu cuenta ya está activa. Desde el panel puedes contratar servicios de gestoría
              inmobiliaria, ver el estado de tus pedidos y subir la documentación necesaria.
            </Text>
