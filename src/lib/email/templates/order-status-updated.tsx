...
export function OrderStatusUpdatedEmail({
  ...
  return (
    <Html>
      <Head />
      <Preview>Estado actualizado: {statusLabel}</Preview>
      <Body style={body}>
        <Container style={card}>
          ...
          <Section style={inner}>
            <Heading style={h1}>Actualización de tu pedido</Heading>
            <Text style={p}>Hola {customerName || "cliente"},</Text>
            <Text style={p}>
              El estado de <strong>{serviceName}</strong> es ahora: <strong>{statusLabel}</strong>.
            </Text>
            <Text style={p}>Puedes ver más detalles en tu panel.</Text>
