 ...
 * 1. Añadir slug a *_LOCAL_PUBLISHED_SLUGS en su lib.
 * 2. Si es barrio/municipio AMB de contrato o redactar alquiler, usar slug en barcelona-metro-contrato-alquiler-slugs.ts.
 * 3. El componente *-local-city-links debe leer getPublished*() (sin listas hardcodeadas de ciudades).
 * 4. Añadir la card en blog-local-cities-section.tsx si es un producto nuevo.
 *
 * Este array sirve de inventario rápido (hubs); no renderiza la UI.
 */
