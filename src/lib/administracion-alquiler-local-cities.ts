...
export const ADMINISTRACION_ALQUILER_LOCAL_CITIES: AdministracionAlquilerLocalCityDefinition[] = [
  ...
  },
  {
    ...
    barrios: [
      ...
      "Sants-Montjuïc",
      "Sant Martí (Poblenou, Vila Olímpica)",
      "Sarrià-Sant Gervasi",
      "Nou Barris",
      "Ciutat Vella (Gòtic, Born, Raval, Barceloneta)",
      "Sarrià",
      "Vila de Gràcia",
      "Horta-Guinardó",
      "Sant Andreu",
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Sí. Además de esta página de Barcelona capital, hay landings hiperlocales bajo /administracion-alquiler/ en los diez distritos, barrios finos como El Born, Barri Gòtic, La Barceloneta, Poblenou, Vila Olímpica, Sarrià, Vila de Gràcia, Pedralbes, El Raval o la Sagrada Família, y municipios del AMB (L'Hospitalet, Cornellà, Esplugues, Sant Joan Despí, Sant Adrià, Castelldefels, Sant Cugat, Badalona) — cada una con precios de referencia y casos operativos propios.",
      },
    ],
